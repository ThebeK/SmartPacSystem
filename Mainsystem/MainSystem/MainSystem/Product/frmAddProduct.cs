...
namespace MainSystem
{
    public partial class frmAddProduct : Form
    {
        ...
        {
            InitializeComponent();
            productBrandBindingSource1.DataSource = db.Product_Brand.ToList();
            sheetBindingSource1.DataSource = db.Sheets.ToList();
            widthBindingSource1.DataSource = db.Widths.ToList();
            pLengthBindingSource1.DataSource = db.pLengths.ToList();
            plyBindingSource1.DataSource = db.Plies.ToList();
            packSizeBindingSource1.DataSource = db.Pack_Size.ToList();
            productTypeBindingSource2.DataSource = db.Product_Type.ToList();
        }
        bool correct = false;
